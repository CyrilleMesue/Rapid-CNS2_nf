...
bedtools intersect  -a ${OUT_PATH}/${filename}.tmp.bed  -b ${MNP_BED}  -wa -wb > ${OUT_PATH}/${filename}.EPIC.bed
...
echo -e "$column_names" > ${OUT_PATH}/${filename}.EPIC.subset.bed

# Append the content of the input file to the output file
awk '{print $1,$2,$3,$4,$5,$12}' ${OUT_PATH}/${filename}.EPIC.bed >> ${OUT_PATH}/${filename}.EPIC.subset.bed
